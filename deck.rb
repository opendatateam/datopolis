module Deck
  ...
  def self.build(lang)
    puts "Building deck with lang=#{lang}"
    I18n.locale = lang
    ...
    Squib::Deck.new(cards: 1, width: 825, height: 1125, layout: 'layout.yml') do
      ...
      text str: I18n.t("todo.title"), layout: 'TodoTitle'
      svg file: "components/ToolCards_Icons/Todo_Checkbox.svg", layout: 'TodoCheck1'
      text str: I18n.t("todo.step_1.main"), layout: 'Todo1'
      text str: I18n.t("todo.step_1.sub"), layout: 'TodoSub1'
      svg file: "components/ToolCards_Icons/Todo_Checkbox.svg", layout: 'TodoCheck2'
      text str: I18n.t("todo.step_2.main"), layout: 'Todo2'
      text str: I18n.t("todo.step_2.sub"), layout: 'TodoSub2'
      svg file: "components/ToolCards_Icons/Todo_Checkbox.svg", layout: 'TodoCheck3'
      text str: I18n.t("todo.step_3.main"), layout: 'Todo3'
      text str: I18n.t("todo.step_3.sub"), layout: 'TodoSub3'
      svg file: "components/ToolCards_Icons/Todo_Checkbox.svg", layout: 'TodoCheck4'
      text str: I18n.t("todo.step_4.main"), layout: 'Todo4'
      text str: I18n.t("todo.step_4.sub"), layout: 'TodoSub4'
      svg file: "components/ToolCards_Icons/Todo_Checkbox.svg", layout: 'TodoCheck5'
      text str: I18n.t("todo.step_5.main"), layout: 'Todo5'
      text str: I18n.t("todo.step_5.sub"), layout: 'TodoSub5'
      svg file: "components/ToolCards_Icons/Todo_Checkbox.svg", layout: 'TodoCheck6'
      text str: I18n.t("todo.step_6.main"), layout: 'Todo6'
      text str: I18n.t("todo.step_6.sub"), layout: 'TodoSub6'
      svg file: "components/ToolCards_Icons/Todo_Checkbox.svg", layout: 'TodoCheck7'
      text str: I18n.t("todo.step_7.main"), layout: 'Todo7'
      text str: I18n.t("todo.step_7.sub"), layout: 'TodoSub7'
